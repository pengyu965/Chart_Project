...
class Chartdata(Dataset):
    def __init__(self, img_path, gt_path1, gt_path2 = None):
        self.img_path = img_path
        self.gt_path1 = gt_path1
        self.gt_path2 = gt_path2
    def __len__(self):
    ...
    def __getitem__(self, idx):
        ...
        gt1_images_path = os.path.join(self.gt_path1, img_name)
        input_images = cv2.imread(input_images_path)
        gt1_images = cv2.imread(gt1_images)
        if self.gt_path2:
            gt2_images_path = os.path.join(self.gt_path2, img_name)
