...
img_path = "../data/PMC/tasks345_data/images/"
gt_path = "../data/PMC/tasks345_data/json_gt_new/"

rs_img_path = "../data/PMC/tasks345_data/rs_images/"
rs_gt_path = "../data/PMC/tasks345_data/rs_json_gt_new/"
...
_file_name_list = os.listdir(gt_path)

file_name_list = []


for name in _file_name_list:
...
# verify(rs_img_path, rs_gt_path, "PMC4078576___ijerph-11-06231-g009")