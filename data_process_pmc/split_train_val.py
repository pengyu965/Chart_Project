...
sumit_image_path = "../data/PMC/tasks345_data/rs_images/"

sumit_train_image_path = "../data/PMC/tasks345_data/rs_images/train/"
sumit_val_image_path = "../data/PMC/tasks345_data/rs_images/val/"
...
train_list = total_list[:-int(total_len*1./2)]
val_list = total_list[-int(total_len*1./2):]
